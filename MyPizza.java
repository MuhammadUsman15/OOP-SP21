...
public class MyPizza {
	...
	public MyPizza(String size) {
		this.size=size;
		cheese=0;
		pepperoni=0;
		ham=0;
	}
	public MyPizza(String size,int cheese) {
		this.size=size;
		this.cheese=cheese;
		pepperoni=0;
		ham=0;
	}
	public MyPizza(String size,int cheese,int pepperoni) {
		this.size=size;
		this.cheese=cheese;
		this.pepperoni=pepperoni;
		ham=0;
	}
	public MyPizza(String size,int cheese,int pepperoni,int ham) {
		this.size=size;
		this.cheese=cheese;
		this.pepperoni=pepperoni;
		this.ham=ham;
